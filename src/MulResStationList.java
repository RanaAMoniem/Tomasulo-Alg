...
public class MulResStationList {
	...
	public String toString(){
		 list.forEach( (tag, station) -> System.out.println("Multiplication Reservation Station List Items: " + "Tag: " + tag + "| Buffer Info: " + station.toString())); 
		return "";
	}
